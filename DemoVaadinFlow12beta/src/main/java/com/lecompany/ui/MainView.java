...
import com.lecompany.ui.components.OfflineBanner;
...
import com.lecompany.ui.views.login.LoginView;

import static com.lecompany.ui.utils.BakeryConst.*;


@Viewport(VIEWPORT)
@PWA(name = "Bakery App Starter", shortName = "DemoVaadinFlow12beta", startPath = "login",
...
public class MainView extends AbstractAppRouterLayout implements BeforeEnterObserver {
	...
	protected void configure(AppLayout appLayout, AppLayoutMenu menu) {
		appLayout.setBranding(new Span("DemoVaadinFlow12beta"));
